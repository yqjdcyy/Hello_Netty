package com.yao.sample.im.client.handler;
            ...
            public void run() {
                ...
                do {
                    if (scanner.hasNext()) {
                        ...
                        if (IMP.EXIT.toString().equalsIgnoreCase(input)) {
                            message = new IMMessage(IMP.LOGOUT.getName(), "Console", time, nickName);
                        } else {
                            message = new IMMessage(IMP.CHAT.getName(), time, nickName, input);
                        }
                    }
                }
